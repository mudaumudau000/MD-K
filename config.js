...
module.exports = { 
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "彡ALPHA HUNTER'S ❐彡",
    STICKER_AUTHOR: process.env.STICKER_AUTHOR || "thendo",
    BOT_PRESENCE: process.env.BOT_PRESENCE || "available",
    REACT: process.env.REACT || false,
    READ_MESSAGE: process.env.READ_MESSAGE || "false",
    OWNER_NAME: process.env.OWNER_NAME || "Mudau thrndo",
    ...
    AUDIO_DATA: process.env.AUDIO_DATA || "彡ALPHA HUNTER'S ❐彡;😈",
    GUARD: process.env.GUARD || "27799648540",
